...
function main() {
  ...
  let startingWorkspace = {"blocks":{"languageVersion":0,"blocks":[{"type":"tick","id":"v[MR-3O^(3+t^uTRqeOB","x":8,"y":142,"inputs":{"body":{"block":{"type":"variables_set","id":"%ZK]w1wEG_seIYvj!-|?","fields":{"VAR":{"id":"|!f91waXz)DQ0(?QD~s9"}},"inputs":{"VALUE":{"block":{"type":"position_distance_between","id":"F]pZnW:Gyugvm5b/2_`Q","inputs":{"first":{"block":{"type":"get_entity_position","id":"xldTQUyn7WE@iK,O5r$,","inputs":{"entity":{"shadow":{"type":"current_entity","id":"r`jdo+~9qzAOf;g_!d6p"},"block":{"type":"current_entity","id":"%FmfkO;+GTT8DNw~02/r"}}}}},"second":{"block":{"type":"variables_get","id":"b!3M-_LyvQx{8=|2x`5_","fields":{"VAR":{"id":")90`h6(T(mF:7tw:UjEq"}}}}}}}},"next":{"block":{"type":"controls_if","id":"V~g$Wthx)[+X$ZjYN_4G","inputs":{"IF0":{"block":{"type":"logic_compare","id":"udHO3}mUFoX8iM;3QK+Z","fields":{"OP":"GTE"},"inputs":{"A":{"block":{"type":"variables_get","id":"VRJlXq@;-#t(ECh5xQ9%","fields":{"VAR":{"id":"|!f91waXz)DQ0(?QD~s9"}}}},"B":{"block":{"type":"variables_get","id":"_`W9Fthvrsa_Pkd]G([`","fields":{"VAR":{"id":"74o69y/44EX7aB)-V;4S"}}}}}}},"DO0":{"block":{"type":"set_entity_position","id":"}jD!1;)GHzWq;2LlFXu9","inputs":{"entity":{"shadow":{"type":"current_entity","id":"z;ZQI)yD{s2I:;K0A9K8"},"block":{"type":"spawn_template","id":"/W=e,dQGUbmHd=~Sr|/*","fields":{"template_name":"template1"}}},"position":{"shadow":{"type":"position","id":"=N9)gOGv7W1eu1G_9-Od","inputs":{"x":{"shadow":{"type":"math_number","id":"k0YEj)0%7u/7WpwU[^2h","fields":{"NUM":0}}},"y":{"shadow":{"type":"math_number","id":"d.{ud1]4ScP~Em#xO/%1","fields":{"NUM":0}}},"z":{"shadow":{"type":"math_number","id":"Q1b[h$k0iz2@R3fIO)ZV","fields":{"NUM":0}}}}},"block":{"type":"get_entity_position","id":"ejc{!qZ$X3xLEz^=x!R=","inputs":{"entity":{"shadow":{"type":"current_entity","id":"~z`+=]%WR1cr5MeRVHY+"}}}}}},"next":{"block":{"type":"set_entity_position","id":"pc:cqd:c2R17_2vvdVao","inputs":{"entity":{"shadow":{"type":"current_entity","id":"z;ZQI)yD{s2I:;K0A9K8"},"block":{"type":"spawn_template","id":"V5rdT`LDqnyZ4*A3E%0?","fields":{"template_name":"template2"}}},"position":{"shadow":{"type":"position","id":"=N9)gOGv7W1eu1G_9-Od","inputs":{"x":{"shadow":{"type":"math_number","id":"k0YEj)0%7u/7WpwU[^2h","fields":{"NUM":0}}},"y":{"shadow":{"type":"math_number","id":"d.{ud1]4ScP~Em#xO/%1","fields":{"NUM":0}}},"z":{"shadow":{"type":"math_number","id":"Q1b[h$k0iz2@R3fIO)ZV","fields":{"NUM":0}}}}},"block":{"type":"get_entity_position","id":"1Uw0?UDCzlA7.T:veLk}","inputs":{"entity":{"shadow":{"type":"current_entity","id":"9g%q.6!A*m@WSSyc39z{"}}}}}},"next":{"block":{"type":"variables_set","id":"teV.E9.$/r:si{WBoj.S","fields":{"VAR":{"id":")90`h6(T(mF:7tw:UjEq"}},"inputs":{"VALUE":{"block":{"type":"get_entity_position","id":"{?dtN^/O6_%WF9(:zI]w","inputs":{"entity":{"shadow":{"type":"current_entity","id":"r`jdo+~9qzAOf;g_!d6p"},"block":{"type":"current_entity","id":"eb+97EOzjKeN03*M{xOh"}}}}}}}}}}}}},"next":{"block":{"type":"change_entity_position_by","id":"K`EeeymB,Xb5{%Z{jz`m","inputs":{"position":{"shadow":{"type":"position","id":"~x4)^YG4Y2nn4`dmjZw{","inputs":{"x":{"shadow":{"type":"math_number","id":"W:gS{1ho-?EM[HhTx|Rj","fields":{"NUM":0}}},"y":{"shadow":{"type":"math_number","id":"R_9U?Ym6wLw+@%i*iAiM","fields":{"NUM":0}}},"z":{"shadow":{"type":"math_number","id":"~)Pwjvh]|z4jcu:c5B8/","fields":{"NUM":0}}}}},"block":{"type":"position_move_towards","id":"lY++v%3gKWu4HK%*4zlY","inputs":{"target":{"block":{"type":"get_entity_position","id":"GnmFZVGW=.?^f%aYQ+Eh","inputs":{"entity":{"shadow":{"type":"current_entity","id":"E|Iuw@*X)lHq,+?`cn$x"},"block":{"type":"player_entity","id":";Ak;@t6J%;y:1U`-~MnB"}}}}},"current":{"block":{"type":"get_entity_position","id":"%Q`f0Mn-v1j+uA+sK:=@","inputs":{"entity":{"shadow":{"type":"current_entity","id":"g[-*XCEen2`?Lwa0YMM["}}}}},"distance":{"shadow":{"type":"math_number","id":"J*-v%b4nSXUbQQV$hb8z","fields":{"NUM":30}}}}}}},"next":{"block":{"type":"send_event_to_entity","id":"x#%^VWR]I(hkQy=3y,nl","inputs":{"event":{"shadow":{"type":"text","id":"#]sFq0!7Q;KIx^2UyQ;W","fields":{"TEXT":"event_setText"}}},"entity":{"block":{"type":"current_entity","id":"fv|dpyYWD}ZM(0mk}Bn{"}},"value":{"shadow":{"type":"text","id":"F?ZprxDVQ-^}EE?8:-uG","fields":{"TEXT":""}},"block":{"type":"variables_get","id":"K:;MKlb#5`dE}yd8_UXs","fields":{"VAR":{"id":"|!f91waXz)DQ0(?QD~s9"}}}}}}}}}}}}}}},{"type":"start","id":"uiXHuW+~Om(2;jK:`{Br","x":0,"y":0,"inputs":{"body":{"block":{"type":"variables_set","id":"C3X8q:BdDz.b;7F8+u~u","fields":{"VAR":{"id":"74o69y/44EX7aB)-V;4S"}},"inputs":{"VALUE":{"block":{"type":"math_number","id":";{rii!_~A/u:O;N(mzfp","fields":{"NUM":100}}}},"next":{"block":{"type":"variables_set","id":"PeHZhG~GE-I$o7:-7(}g","fields":{"VAR":{"id":")90`h6(T(mF:7tw:UjEq"}},"inputs":{"VALUE":{"block":{"type":"get_entity_position","id":"j$6V#8zvG+bqqPq^smXi","inputs":{"entity":{"shadow":{"type":"current_entity","id":"r`jdo+~9qzAOf;g_!d6p"},"block":{"type":"current_entity","id":"ZH7!WW2Tn?~paIHT5=T}"}}}}}}}}}}}}]},"variables":[{"name":"otherEntity","id":"otherEntity"},{"name":"lastPosition","id":")90`h6(T(mF:7tw:UjEq"},{"name":"spawnDistance","id":"74o69y/44EX7aB)-V;4S"},{"name":"distanceToLastPosition","id":"|!f91waXz)DQ0(?QD~s9"}]};

  Blockly.serialization.workspaces.load(startingWorkspace, workspace);
